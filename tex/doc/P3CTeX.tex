...
{ P3CTeX by~	\textbf{ #1 } \label{alumne} is a \LaTeX repository created during my
		 software engineering studies at UOC. It is based on the official
		 \LaTeX template provided by the university,
		 all the images used are public and available at \url{http://www.uoc.edu/portal/ca/llibre-estil}.}
\begin{document}
