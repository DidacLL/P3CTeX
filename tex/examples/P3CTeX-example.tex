...
\hspace*{\fill}\begin{CODE}[language=pxJava]{FFSDA}
	@Overwrite
...
%
%% 4. Bash — plain style
%\pxLSTsetup[pastel]{pxBash}[framed]
...
Fragment en Java: \pxCodeInline{int n = 0;} i \pxCodeInline{return n + 1;}.
Un altre fragment en Bash: \pxCodeInline[pxBash]{echo "fi"}.
