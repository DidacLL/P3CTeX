...
valors actuals (esperat z,a): \pxListAll{LCLR}{vals}.\\
\pxSET LCLR.vals=A
valors actuals (esperat A): \pxGETtl(LCLR.vals).\\
\pxPUT LCLR.vals+=B
valors actuals (esperat AB): \pxPRINTlst LCLR.vals()\\
valors actuals (esperat A $\pi$ B): \pxPRINTlst LCLR.vals(~$\pi$~)\\
\end{document}