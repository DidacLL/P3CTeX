...
\cs_new:Nn \__iftoc:nn {
	\bool_if:NTF  \l_pxdoc_usetoc_bool {#1}{#2}
}
\cs_new:Nn \__ifplagi:nn {
	\bool_if:NTF  \l_pxdoc_useplagi_bool {#1}{#2}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%END_FOLD%%%
