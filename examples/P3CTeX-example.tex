...
\hspace*{\fill}\begin{pxCode}[language=pxJava]{FFSDA}
	@Overwrite
...
\pxCodeSet[pastel]{algoritme}[framed]
\begin{CodeBox}{lst-alg-ex}{Algorisme: factorial}{[lst:alg-ex]}{Calcul del factorial de manera iterativa.}
...
%
%% 4. Bash — plain style
%\pxCodeSet[pastel]{pxBash}[framed]
\begin{miniCode}[.5\linewidth]
#!/bin/bash
cd tex/
...
Fragment en Java: \pxCodeIn{int n = 0;} i \pxCodeIn{return n + 1;}.
Un altre fragment en Bash: \pxCodeIn[pxBash]{echo "fi"}.
